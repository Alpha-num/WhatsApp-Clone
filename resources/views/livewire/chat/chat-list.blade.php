<div class="min-h-full w-2/5">
    ...
    <div class="flex justify-around p-2 relative">
        <input type="text" class="w-4/5 h-12 bg-gray-200 shadow-sm rounded-md pl-16 focus:outline-none" placeholder="Search or start a new chat" />
        <span class="pt-2">
            <svg viewBox="0 0 24 24" height="30" width="30" preserveAspectRatio="xMidYMid meet" class="" version="1.1" x="0px" y="0px" enable-background="new 0 0 24 24"><title>filter</title><path fill="currentColor" d="M10,18.1h4v-2h-4V18.1z M3,6.1v2h18v-2H3z M6,13.1h12v-2H6V13.1z"></path></svg>
        </span>
        <span class="absolute left-10 top-4 text-gray-400">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
